...
class AuthRateLimitServiceTest {
    ...
    void checkAllowsUpToMaxThenThrows() {
        AuthRateLimitService limiter = new AuthRateLimitService(60_000L, 2, 5, 10, 10, 5);
    ...
    void checkTreatsBlankIpAndIdentifierAsUnknown() {
        AuthRateLimitService limiter = new AuthRateLimitService(60_000L, 1, 5, 10, 10, 5);
    ...
    void zeroMaxDisablesLimit() {
        AuthRateLimitService limiter = new AuthRateLimitService(60_000L, 0, 5, 10, 10, 5);
    ...
    void expiredEntriesArePrunedFromTheWindow() throws InterruptedException {
        AuthRateLimitService limiter = new AuthRateLimitService(20L, 1, 5, 10, 10, 5);
    ...
    void differentActionsHaveSeparateBuckets() {
        AuthRateLimitService limiter = new AuthRateLimitService(60_000L, 1, 1, 10, 10, 5);
